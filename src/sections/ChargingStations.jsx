...
function ChargingStations() {
  ...
  return (
    <div>
        <div className='max-w-[1240px] w-full mx-auto py-16 px-6 md:grid md:grid-cols-2'>
        <img  data-aos='fade-up-right' data-aos-duration='1000' src={image} className='w-[400px] h-[400px] mx-auto' />
        <div  data-aos='fade-up-left' data-aos-duration='1000'>
        <h2 className='text-4xl font-semi-bold bg-gradient-to-bl from-[#2c815e] to-[#5ebb52] inline-block text-transparent bg-clip-text'>The Charging Infrastructure</h2>
